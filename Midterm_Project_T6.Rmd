...
# Create a custom color palette
my_colors <- c("#004c00", "#006600", "#198c19", "#4ca64c", "#66b266", "#7fbf7f", "#b2d8b2","#e5f2e5")

# Create the bar plot with customizations
ggplot(completion_data, aes(x = Offer, y = CompletionRate*100, fill = Offer)) +
  ...
  scale_y_continuous(labels = scales::percent_format(scale = 1),
                     breaks = seq(0, 1, by = 0.1)) +  # Customize the breaks for the y-axis
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) +  # Rotate x-axis labels
  theme(plot.title = element_text(size = 20, hjust = 0.5)) +  # Title font size
  theme(legend.position = "none") +  # Remove legend
  geom_text(aes(label = scales::percent(CompletionRate)), vjust = -0.5, size = 4)  # Add data labels

# Save the plot as an image file (e.g., PNG)
ggsave("creative_bar_plot.png", width = 10, height = 6, dpi = 300)
